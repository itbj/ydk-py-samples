...
"""
Encode configuration for model Cisco-IOS-XR-lib-keychain-cfg.

usage: cd-encode-xr-lib-keychain-cfg-22-ydk.py [-h] [-v]
...
def config_keychains(keychains):
    ...
    keychain.chain_name = "CHAIN2"
    key = keychain.macsec_keychain.macsec_keys.MacsecKey()
    key.key_id = "20"
    key.macsec_key_string = key.MacsecKeyString()
    key.macsec_key_string.string = "0256550958525A771B1E584B5643475D5B547B79777C6663754356445055030F0F03055C504C430F0F07020006005E0D51570905574753520C5B575D72181B5F4E"
