...
"""
Copy configuration for model Cisco-IOS-XE-native.

usage: nc-copy-config-xe-native-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # netconf.copy_config(provider, Datastore.running, native)
