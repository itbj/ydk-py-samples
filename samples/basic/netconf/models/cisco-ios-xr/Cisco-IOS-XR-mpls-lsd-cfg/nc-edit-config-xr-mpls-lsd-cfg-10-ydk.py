...
"""
Edit configuration for model Cisco-IOS-XR-mpls-lsd-cfg.

usage: nc-edit-config-xr-mpls-lsd-cfg-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # netconf.edit_config(provider, Datastore.candidate, mpls_lsd)
