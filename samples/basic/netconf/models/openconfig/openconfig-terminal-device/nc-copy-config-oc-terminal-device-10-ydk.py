...
"""
Copy configuration for model openconfig-terminal-device.

usage: nc-copy-config-oc-terminal-device-10-ydk.py [-h] [-v] device
...
def config_terminal_device(terminal_device):
    """Add config data to terminal_device object."""
    pass
...
if __name__ == "__main__":
    ...
    config_terminal_device(terminal_device)  # add object configuration

    # copy configuration to NETCONF device
    # netconf.lock(provider, Datastore.candidate)
    # netconf.copy_config(provider, Datastore.candidate, terminal_device)
