...
def config_native(native):
    ...
    definition.name = "VRF1"
    definition.rd = "65000:1"
    definition.description = "IPv4 VRF with Route Target"

    # Address-Family Creation
    ipv4 = definition.address_family.Ipv4()
    ipv4.parent = definition.address_family

    # Route Target Creation
    export = ipv4.route_target.Export()
    export.asn_ip = "65000:1"
    import_ = ipv4.route_target.Import_()
    import_.asn_ip = "65000:1"

    ipv4.route_target.export.append(export)
    ipv4.route_target.import_.append(import_)

    definition.address_family.ipv4 = ipv4
