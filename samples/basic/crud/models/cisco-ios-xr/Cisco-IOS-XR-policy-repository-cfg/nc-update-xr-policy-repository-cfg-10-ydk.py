...
"""
Update configuration for model Cisco-IOS-XR-policy-repository-cfg.

usage: nc-update-xr-policy-repository-cfg-10-ydk.py [-h] [-v] device
...
if __name__ == "__main__":
    ...
    # crud.update(provider, routing_policy)
