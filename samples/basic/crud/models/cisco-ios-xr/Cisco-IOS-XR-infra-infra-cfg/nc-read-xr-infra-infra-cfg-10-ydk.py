...
"""
Read all data for model Cisco-IOS-XR-infra-infra-cfg.

usage: nc-read-xr-infra-infra-cfg-10-ydk.py [-h] [-v] device
...
def process_banners(banners):
    """Process data in banners object."""
    pass
