...
"""
Update configuration for model openconfig-acl.

usage: gn-update-oc-acl-10-ydk.py [-h] [-v] device

positional arguments:
  device         NETCONF device (http://user:password@host:port)
